...
// Colorize takes the output of Diff and adds ANSI color codes for terminal display.
func Colorize(diff []byte) string {
	if len(diff) == 0 {
		return ""
	}
